...
def map_reduce(file_path, chunk_size=5):
    ...
    # Find the hottest and coolest year
...
if __name__ == "__main__":
    hottest_year, hottest_data, coolest_year, coolest_data = map_reduce('weather_data.csv', chunk_size=5)
